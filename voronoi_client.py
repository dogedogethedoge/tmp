...
'''
        ...
        if self.last_opponent_move == None:
            ...
            if opponent_row < 500 and opponent_col < 500:
                if self.__is_valid_move(move_row + 50, move_col + 50):
                    return move_row + 50, move_col + 50

                if self.__is_valid_move(move_row + 60, move_col + 50):
                    return move_row + 60, move_col + 50

                if self.__is_valid_move(move_row + 50, move_col + 60):
                    return move_row + 50, move_col + 60

                if self.__is_valid_move(move_row + 60, move_col + 60):
                    return move_row + 60, move_col + 60
